...
export type ProductOverviewFragment = { __typename?: 'Product', name: string, power: string, quantity: number, price: number, img_url: string } & { ' $fragmentName'?: 'ProductOverviewFragment' };
